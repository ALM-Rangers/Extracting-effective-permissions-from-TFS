        ...
        private static readonly List<Permission> Permissions = new List<Permission>
                                                                   {
                                                                       ...
                                                                       // Git Source Control
                                                                       new Permission(PermissionScope.GitSourceControl, "Administer", "Administer", TeamFoundation.Git.Common.GitRepositoryPermissionsNames.Administer, TeamFoundation.Git.Common.GitRepositoryPermissions.Administer, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Read", "GenericeRead", TeamFoundation.Git.Common.GitRepositoryPermissionsNames.GenericRead, TeamFoundation.Git.Common.GitRepositoryPermissions.GenericRead, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Contribute", "GenericContribute", TeamFoundation.Git.Common.GitRepositoryPermissionsNames.GenericContribute, TeamFoundation.Git.Common.GitRepositoryPermissions.GenericContribute, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Rewrite and destroy history (force push)", "ForcePush", TeamFoundation.Git.Common.GitRepositoryPermissionsNames.ForcePush, Microsoft.TeamFoundation.Git.Common.GitRepositoryPermissions.ForcePush, string.Empty),
                                                                       new Permission(PermissionScope.GitSourceControl, "Branch Creation", "CreateBranch", TeamFoundation.Git.Common.GitRepositoryPermissionsNames.CreateBranch, TeamFoundation.Git.Common.GitRepositoryPermissions.CreateBranch, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Tag Creation", "CreateTag", TeamFoundation.Git.Common.GitRepositoryPermissionsNames.CreateTag, TeamFoundation.Git.Common.GitRepositoryPermissions.CreateTag, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Note Management", "ManageNote", TeamFoundation.Git.Common.GitRepositoryPermissionsNames.ManageNote, TeamFoundation.Git.Common.GitRepositoryPermissions.ManageNote, string.Empty), 
                                                                   };
